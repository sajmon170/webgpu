...
impl Mesh {
    ...
    const VERTICES: &[Vertex] = &[
        ...
        Vertex { pos: [-1.0,    0.3,   0.0], uv: [-1.0,    0.3,   0.0]},
        Vertex { pos: [-0.55,  -0.15,  0.0], uv: [-0.55,  -0.15,  0.0]},
        Vertex { pos: [-0.6,   -0.9,   0.0], uv: [-0.6,   -0.9,   0.0]},
        Vertex { pos: [ 0.0,   -0.6,   0.0], uv: [ 0.0,   -0.6,   0.0]},
        Vertex { pos: [ 0.6,   -0.9,   0.0], uv: [ 0.6,   -0.9,   0.0]},
        Vertex { pos: [ 0.55,  -0.15,  0.0], uv: [ 0.55,  -0.15,  0.0]},
        Vertex { pos: [ 1.0,    0.3,   0.0], uv: [ 1.0,    0.3,   0.0]},
        Vertex { pos: [ 0.35,   0.45,  0.0], uv: [ 0.35,   0.45,  0.0]},
